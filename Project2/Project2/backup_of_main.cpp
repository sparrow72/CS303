...
//	for (cTime = 1;cTime < 100000; cTime++)
...
//		int nextExtFloor = intIter->first, currentIntFloor = (*intIter).first, nextIntFloor = (*intIter).first, nextFloor = (*intIter).first; //Next stop
...
//		if (currentIntFloor <= nextExtFloor && nextExtFloor <= nextIntFloor)
//			nextFloor = nextExtFloor;
//		else if (nextIntFloor > currentIntFloor)
//			nextFloor = nextIntFloor;
//
//		//moves elevator
//		////////////////////////////////
//		////////////////////////////////
